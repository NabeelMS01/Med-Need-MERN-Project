...
function ViewProfile({profile}) {
    ...
    const {  setviewProfile } = useContext(ComponentContext);
  console.log(profile);
  ...
  useEffect(() => {
    ...
    setUserData(profile&&profile.userdata);
  }, [state]);

  async function getProfileData() {
    try {
      const token = JSON.parse(localStorage.getItem("userInfo"));
      setProfileImg(profile.profile.profile_img);
      setUserProfile(profile.profile);
      setResume(profile.profile.resume);
  ...
  let birthdate = moment(profile&&profile.date_of_birth).format("L");
            ...
            <div className="bg-white p-3 border-t-4 border-green-400">
              <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                <li className="flex items-center py-3">
                  ...
                  <span className="ml-auto">
                    ...
                    ) : profile&&profile.approval_status == "declined" ? (
                      <span className="bg-red-500 py-1 px-2 rounded text-white text-sm">
                        declined
                      </span>
                    ) :profile&&profile.approval_status == "verified" ? (
                ...
                <li className="flex items-center py-3">
                  ...
                  <span className="ml-auto">
                    {moment(userData&&userData.createdAt).format("LL")}
                  </span>
                </li>
              </ul>
              <div className="image overflow-hidden">
                <img
                  ...
                  src={`${
                    profile&&  profile.profile_img.url ||
          ...
          <div className="w-full md:w-9/12 mx-2 h-64">
            ...
            <div className="bg-white p-3 shadow-sm rounded-sm">
                ...
                <div className="grid md:grid-cols-2 text-sm">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">
                      {profile&&userProfile.gender || "Not updated"}
                    </div>
                  </div>
                  <div className="grid grid-cols-2">
                  ...
                  {profile&&profile.experience ? (
                    <div className="grid grid-cols-2">
                      <div className="px-4 py-2 font-semibold">Experiance.</div>
                      <div className="px-4 py-2">{profile&&profile.experience}</div>
                    </div>
                  ) : null}
              ...
              {profile&&profile.resume.url ? (
                <a href={` ${profile&&profile.resume.url}`} target={"_blank"}>
                  {" "}
            ...
            <div className="bg-white p-3 shadow-sm rounded-sm">
              <div className="grid grid-cols-3 m-auto">
                <div>
                {profile&& profile.approval_status=="verified"? <Button
                    variant="contained"
                    color="success"
                   disabled
                ...
                <div>
                 { profile&&profile.approval_status=='declined'?
                  ...
                  : <> <Button
                    ...
                    color="error"
                    onClick={() => {
                      handleDecline(profile&&profile._id);
                    }}
                  >
                    decline
                  </Button> </>
